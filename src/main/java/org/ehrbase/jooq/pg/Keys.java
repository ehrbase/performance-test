...
import org.ehrbase.jooq.pg.tables.Encoding;
...
public class Keys {
    ...
    public static final UniqueKey<EncodingRecord> ENCODING_PKEY = Internal.createUniqueKey(
            Encoding.ENCODING, DSL.name("encoding_pkey"), new TableField[] {Encoding.ENCODING.PATH}, true);

...
public class JsonPartyRelated extends AbstractRoutine<JSON> {
     ...
     */
    public static final Parameter<String> NAMESPACE =
            Internal.createParameter("namespace", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>ehr.json_party_related.ref_type</code>.
     */
    public static final Parameter<String> REF_TYPE =
            Internal.createParameter("ref_type", SQLDataType.CLOB, false, false);
     ...
     */
    public static final Parameter<DvCodedTextRecord> RELATIONSHIP = Internal.createParameter(
            "relationship", DvCodedText.DV_CODED_TEXT.getDataType(), false, false);

    /**
     * Create a new routine call instance
     */
    public JsonPartyRelated() {
        super("json_party_related", Ehr.EHR, SQLDataType.JSON);
    ...
    /**
     * Set the <code>relationship</code> parameter to the function to be used
     * with a {@link org.jooq.Select} statement
     */

...
public class FolderItems extends TableImpl<FolderItemsRecord> {
     ...
     */
    public final TableField<FolderItemsRecord, UUID> FOLDER_ID =
            createField(DSL.name("folder_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>ehr.folder_items.object_ref_id</code>.
     */
    public final TableField<FolderItemsRecord, UUID> OBJECT_REF_ID =
            createField(DSL.name("object_ref_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>ehr.folder_items.in_contribution</code>.
     */
    public final TableField<FolderItemsRecord, UUID> IN_CONTRIBUTION =
     ...
     */
    public final TableField<FolderItemsRecord, Timestamp> SYS_TRANSACTION =
     ...
     */
    public final TableField<FolderItemsRecord, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>>
    ...
    public List<ForeignKey<FolderItemsRecord, ?>> getReferences() {
        return Arrays.asList(
                Keys.FOLDER_ITEMS__FOLDER_ITEMS_FOLDER_FKEY,
                Keys.FOLDER_ITEMS__FOLDER_ITEMS_OBJ_REF_FKEY,
                Keys.FOLDER_ITEMS__FOLDER_ITEMS_IN_CONTRIBUTION_FKEY);
    }
    ...
    public Folder folder() {
        if (_folder == null) _folder = new Folder(this, Keys.FOLDER_ITEMS__FOLDER_ITEMS_FOLDER_FKEY);
    ...
    public ObjectRef objectRef() {
        if (_objectRef == null) _objectRef = new ObjectRef(this, Keys.FOLDER_ITEMS__FOLDER_ITEMS_OBJ_REF_FKEY);

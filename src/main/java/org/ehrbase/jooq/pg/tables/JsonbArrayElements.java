...
public class JsonbArrayElements extends TableImpl<JsonbArrayElementsRecord> {
     ...
     */
    public final TableField<JsonbArrayElementsRecord, JSONB> JSONB_ARRAY_ELEMENTS_ =
            createField(DSL.name("jsonb_array_elements"), SQLDataType.JSONB, this, "");
    ...
    public JsonbArrayElements call(JSONB jsonbVal) {
        JsonbArrayElements result = new JsonbArrayElements(
                DSL.name("jsonb_array_elements"), null, new Field[] {DSL.val(jsonbVal, SQLDataType.JSONB)});
    ...
    public JsonbArrayElements call(Field<JSONB> jsonbVal) {
        JsonbArrayElements result =
                new JsonbArrayElements(DSL.name("jsonb_array_elements"), null, new Field[] {jsonbVal});

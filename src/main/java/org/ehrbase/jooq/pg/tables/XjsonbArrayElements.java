...
public class XjsonbArrayElements extends TableImpl<XjsonbArrayElementsRecord> {
     ...
     */
    public final TableField<XjsonbArrayElementsRecord, JSONB> XJSONB_ARRAY_ELEMENTS_ =
            createField(DSL.name("xjsonb_array_elements"), SQLDataType.JSONB, this, "");

    private XjsonbArrayElements(Name alias, Table<XjsonbArrayElementsRecord> aliased) {
        this(alias, aliased, new Field[] {DSL.val(null, SQLDataType.JSONB)});
    }
    ...
    public XjsonbArrayElements call(JSONB entry) {
        XjsonbArrayElements result = new XjsonbArrayElements(
                DSL.name("xjsonb_array_elements"), null, new Field[] {DSL.val(entry, SQLDataType.JSONB)});
    ...
    public XjsonbArrayElements call(Field<JSONB> entry) {
        XjsonbArrayElements result =
                new XjsonbArrayElements(DSL.name("xjsonb_array_elements"), null, new Field[] {entry});

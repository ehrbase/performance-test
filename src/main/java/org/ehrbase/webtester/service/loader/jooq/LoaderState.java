...
public class LoaderState extends TableImpl<LoaderStateRecord> {
    ...
    public static final UniqueKey<LoaderStateRecord> LOADER_STATE_PKEY = Internal.createUniqueKey(
            ...
            DSL.name("loader_state_pkey"),
            new TableField[] {LoaderState.LOADER_STATE.ID},
            true);
    public static final UniqueKey<LoaderStateRecord> LOADER_STATE_KEY_UNIQUE = Internal.createUniqueKey(
            LoaderState.LOADER_STATE,
            DSL.name("loader_state_key_unique"),
            new TableField[] {LoaderState.LOADER_STATE.KEY},
            true);
     ...
     */
    public final TableField<LoaderStateRecord, String> KEY = createField(DSL.name("key"), SQLDataType.CLOB, this, "");
